...
public:
    ...
    {
        balance += amount;
        cout << "Deposited: " << amount << " in Savings Account." << endl;
...
public:
    ...
    {
        balance += amount;
        cout << "Deposited: " << amount << " in Current Account." << endl;
        cout << "New Balance: " << balance;
    }
...
public:
    ...
    {
        balance += amount;
        cout << "Deposited: " << amount << " in FixedTerm Account." << endl;
        cout << "New Balance: " << balance;
    }

    void withdraw(double amount)
    {
        throw logic_error("Withdrawal not allowed in Fixed Term accounts");
    }
};
